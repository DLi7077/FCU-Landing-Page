...
import { MultipleDepositCalc } from "../../../../utils/Calculator";
import numeral from "numeral";

export default function MultipleDeposit() {
  ...
  useEffect(() => {
    const updatedResult = MultipleDepositCalc({
  ...
  }, [initialDeposit, monthlyDeposit, interest, years]);
